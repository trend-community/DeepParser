...
def LoadCommonLexicon(XLocation):
    ...
    Lexicon.LoadLexicon(XLocation + 'LexF.txt')
    Lexicon.LoadLexicon(XLocation + 'StemF.txt')
    Lexicon.LoadLexicon(XLocation + 'Lex-Punctuate.txt')

    # Lexicon.LoadLexicon(XLocation + 'compoundF.txt', lookupSource=LexiconLookupSource.defLex)

    Lexicon.LoadExtraReference(XLocation + 'CuobieziF.txt', Lexicon._LexiconCuobieziDict)
...
def LoadCommon():
    ...
    LoadPipeline(XLocation + 'pipelineF.txt')
