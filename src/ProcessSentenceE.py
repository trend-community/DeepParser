...
def LoadCommonLexicon(XLocation):
    ...
    Lexicon.LoadLexicon(XLocation + 'LexE.txt')
    Lexicon.LoadLexicon(XLocation + 'StemE.txt')
    Lexicon.LoadLexicon(XLocation + 'LexE-Punctuate.txt')
...
def LoadCommon():
    ...
    LoadPipeline(XLocation + 'pipelineE.txt')
